...
const ProductionHistory = () => {
  ...
  const { getProductionHistory } = useHistory();

  const { data, isLoading, isError } = useQuery({
    queryKey: ["productionHistory", page, search],
    queryFn: () => getProductionHistory(page, 10, search),
  });

  if (isError) return <div className="p-4 text-red-500">Error loading Production History</div>;
